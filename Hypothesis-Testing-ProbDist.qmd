...
Patients who underwent CPR for a heart attack and were subsequently admitted to a hospital[^hypothesis-testing-probdist-4] were randomly assigned to either receive a blood thinner (treatment group) or not receive a blood thinner (control group). The outcome variable of interest was whether the patient survived for at least 24 hours.

[^hypothesis-testing-probdist-4]: "Efficacy and safety of thrombolytic therapy after initially unsuccessful cardiopulmonary resuscitation: a prospective clinical trial." The Lancet, 2001.
