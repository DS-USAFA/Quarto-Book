...
We could fit the linear relationship by eye like we did in the case study and obtain estimates of the slope and intercept but this is too ad hoc.[^27-linear-regression-basics-1] So, given a set of data like the `possum`, how do we actually obtain estimates of $\beta_0$ and $\beta_1$? What is the **best** fit line?

[^27-linear-regression-basics-1]: If you want to do try this again use the `plot_ss()` from the last chapter.
...
## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/LRBASICS.html) {.unnumbered}
