...
```{r boot251-fig,fig.cap="The sampling distribution approximated using a bootstrap distribution.",warning=FALSE}
boot_results %>%
...
```{r boot252-fig,fig.cap="The sampling distribution approximated using a bootstrap distribution.",warning=FALSE}
boot_results %>%
...
## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/BOOT.html) {.unnumbered}
