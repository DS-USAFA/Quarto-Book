...
```{r}
#| label: "fig-hist191"
#| fig-cap: "Historgram of the sampling distribution by an approxiamte permutation test."
#| warning: false
results %>%
...
Here we consider an experiment with patients who underwent CPR for a heart attack and were subsequently admitted to a hospital.[^19-hypothesis-testing-simulation-4] Each patient was randomly assigned to either receive a blood thinner (treatment group) or not receive a blood thinner (control group). The outcome variable of interest was whether the patient survived for at least 24 hours.

[^19-hypothesis-testing-simulation-4]: "Efficacy and safety of thrombolytic therapy after initially unsuccessful cardiopulmonary resuscitation: a prospective clinical trial." The Lancet, 2001.
...
The observed test statistic can now be found.[^19-hypothesis-testing-simulation-5]

[^19-hypothesis-testing-simulation-5]: Observed control survival rate: $p_c = \frac{11}{50} = 0.22$. Observed treatment survival rate: $p_t = \frac{14}{40} = 0.35$. Observed difference: $\hat{p}_c - \hat{p}_t = 0.22 - 0.35 = -0.13$.
...
There is something different in this study than in the past studies: in this study, we are particularly interested in whether blood thinners increase **or** decrease the risk of death in patients who undergo CPR before arriving at the hospital.[^19-hypothesis-testing-simulation-6]

[^19-hypothesis-testing-simulation-6]: Realistically, we probably are interested in either direction in the past studies as well, and so we should have used the approach we now discuss in this section. However, for simplicity and the sake of not introducing too many concepts at once, we skipped over these details in earlier sections.
...
## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/HYPTESTSIM.html) {.unnumbered}
=======
>>>>>>> 9f35b31e4cd3f5f316488b29698f940e4b83eeef
