...
> **Exercise**:\
> Describe the shape of the distribution and note anything that you find interesting.[^21-central-limit-theorem-1]

[^21-central-limit-theorem-1]: In general, the distribution is reasonably symmetric. It is unimodal and looks like a normal distribution.
...
We will repeat the body temperature analysis from @sec-HYPTESTDIST homework, now using the CLT. We will use $\alpha = 0.05$. Recall that a paper from the American Medical Association[^21-central-limit-theorem-2] questioned the long-held belief that the average body temperature of a human is 98.6 degrees Fahrenheit. The authors of the paper believe that the average human body temperature is less than 98.6.

[^21-central-limit-theorem-2]: Mackowiak, P. A., Wasserman, S. S., and Levine, M. M. (1992), "A Critical Appraisal of 98.6 Degrees F, the Upper Limit of the Normal Body Temperature, and Other Legacies of Carl Reinhold August Wunderlich," Journal of the American Medical Association, 268, 1578-1580.
...
> **Exercise**:\
> How do you conduct a one-sided test? What if the null value were 0.45?[^21-central-limit-theorem-3]

[^21-central-limit-theorem-3]: We will only extract the $p$-value in this exercise.
