...
d.  Find the following probabilities: $\mbox{P}(X<0.5)$; $\mbox{P}(Y>0.8)$; $\mbox{P}(X<0.2,Y\geq 0.75)$; $\mbox{P}(X<0.2|Y\geq 0.75)$; $\mbox{P}(X<0.2|Y= 0.25)$; Optional - $\mbox{P}(X\leq Y)$.
...
b.  Find the marginal pdfs of $X$ and $Y$.\
c.  Find the conditional pdfs of $X|Y=y$ and $Y|X=x$.\
d.  Find the following probabilities: $\mbox{P}(X<0.5)$; $\mbox{P}(Y>1)$; $\mbox{P}(X<0.5,Y\leq 0.8)$; Optional $\mbox{P}(X<0.5|Y= 0.8)$; $\mbox{P}(Y\leq 1-X)$. (It would probably help to draw some pictures.)

## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/MULTIDISTS.html) {.unnumbered}
