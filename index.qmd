...
In a 2024 reorganization of our inference block, we added a chapter on sampling distributions. The materials for this chapter are borrowed from the sampling distributions lessons by [Skew the Script](https://skewthescript.org/). We have used their materials with minor modifications to transform the lesson activities into a book chapter.
