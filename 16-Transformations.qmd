...
```{r}
#| label: "fig-pdf161"
#| fig-cap: "he pdf of the transformed random variable $Y$"
...
```{r}
#| label: "fig-dens161"
#| fig-cap: "The density plot of the original using simulation."
results %>%
...
```{r}
#| label: "fig-dens162"
#| fig-cap: "The density plot of the transformed random variable from the simulation."
y_results %>%
  gf_density(~y,xlab="X")  %>%
  gf_theme(theme_bw()) %>%
  gf_labs(y="")
...
1.  Let $X$ be a random variable and let $g$ be a function. By this point, it should be clear that $\mbox{E}[g(X)]$ is not necessarily equal to $g(\mbox{E}[X])$.
...
## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/TRANS.html) {.unnumbered}
