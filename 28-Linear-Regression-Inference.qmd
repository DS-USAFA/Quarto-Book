# Linear Regression Inference {#sec-LRINF}
...
#| echo: false 
#| message: false 
#| fig-cap: "Plots of linear regression and residual to illustrate the assumptions of the model."
#| label: "fig-assump271"
...
@fig-scat271 is the scatterplot.

```{r scat271-fig}
#| fig-cap: "Scatterplot of calories and carbohydrate content in Starbucks' products."
#| label: "fig-scat271"
#| warning: false
starbucks %>%
...
Continuing with the `Starbucks` example. In plotting the data, we can have `R` plot the confidence and prediction bands, @fig-ci271. We will observe the width of both of these intervals increase as we move away from the center of the data and also that prediction intervals are wider than the confidence interval.

```{r}
#| fig-cap: "Confidence and predictions bands for linear regression model of calories and carbs in Starbucks' products."
#| warning: false
#| label: "fig-ci271"
starbucks %>%
  gf_point(calories~carb) %>%
