...
This probability makes sense, since the expected value is fairly low. Because, on average, only 0.15 failures would occur every 15 trials, 0 failures would be a very common result. Graphically, the pmf looks like @fig-hw1a.

```{r}
#| label: "fig-hw1a"
#| fig-align: "center"
#| fig-cap: "The pmf for binomail in Homework Problem 1a."
...
## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/DISCRETENAMED.html) {.unnumbered}
