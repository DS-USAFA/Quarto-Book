...
2)  Compile a pdf file report from a RMD or qmd file in R.
...
We will use the [**ggformula**](https://cran.r-project.org/web/packages/ggformula/vignettes/ggformula.html) package to visualize the data. It is a wrapper to the **ggplot2** package which is becoming the industry standard for generating professional graphics. However, the interface for **ggplot2** can be difficult to learn and we will ease into it by using `ggformula`, which makes use of the formula notation introduced above. The **ggformula** package was loaded when we loaded `mosaic`.[^01-data-case-study-4]

[^01-data-case-study-4]: https://cran.r-project.org/web/packages/ggformula/vignettes/ggformula-blog.html
...
## [Solutions Manual](https://ds-usafa.github.io/CPS-Solutions-Manual/CS1.html) {.unnumbered}
