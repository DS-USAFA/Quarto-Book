...
e.  Fill in the blank. There is a probability of 90% that the next vehicle will arrive within \_\_ minutes. This value is known as the 90% percentile of the random variable.\
...
2.  Suppose PFT scores in the cadet wing follow a normal distribution with mean 330 and standard deviation 50.
